'''
ULMFit_extended.py
Extended training on IMDB, 20 epochs and accuracy=0.9526
'''
...
learn.save_encoder('fwd_enc_20e')
...
learn.save_encoder('bwd_enc_20e')
...
learn.load_encoder('fwd_enc_20e')
...
learn_bwd.load_encoder('bwd_enc_20e')
